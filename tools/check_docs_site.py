...
REQUIRED = {
    ...
    "notification-sender": ["TVC_ADMITTED_PROVIDER_ROUTE_REQUIRED", "credential_material_read_by_ara", "provider_execution_performed", "delivery_status", "credential_authority"],
    ...
    "mailbox-poller": [
        "TVC_ADMITTED_PROVIDER_ROUTE_REQUIRED", "credential_material_read_by_ara",
        "provider_execution_performed", "mailbox_mutated",
